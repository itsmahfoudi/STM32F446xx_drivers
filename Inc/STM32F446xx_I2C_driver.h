...
/*
 * This is a Configuration structure for a I2C x peripheral
 */
...
typedef struct {
	...
	uint8_t 	 SR;		 /* To store Repeated start value(ENorDI) */
}I2C_Handle_t;
...
// Enabling and disabling start repetition
...
#define I2C_EVENT_DATA_REQ			10
#define I2C_EVENT_DATA_RCV			11
